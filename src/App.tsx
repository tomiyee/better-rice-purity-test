      ...
      <Stack spacing={3} alignItems="center">
        ...
        <Stack maxWidth={700} spacing={1}>
          <Typography sx={{ fontStyle: "italic" }}>
            The Purity Test has historically served as a segue from O-week to
            true college life at Rice. It's a voluntary opportunity for O-week
            groups to bond, and for students to track the maturation of their
